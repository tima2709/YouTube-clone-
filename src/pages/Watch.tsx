        ...
        <>
            {
                currentPlaying && currentPlaying?.videoId === id && (
                    <div className="max-h-screen overflow-hidden">
                        ...
                        <div className="flex w-full" style={{height: "95vh"}}>
                        ...
                        <span className="after:content-['•'] after:mx-1">
                          {currentPlaying.videoViews} views
                                            ...
                                            <div
                                                className="flex gap-4 flex-col border-solid border-gray-400 border-2 my-5 pb-3 border-l-transparent border-r-transparent">
